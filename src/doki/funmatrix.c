...
int
getitem (struct FMatrix *a, NATURAL_TYPE i, NATURAL_TYPE j, COMPLEX_TYPE *sol)
{
  unsigned int k;
  NATURAL_TYPE aux;
  int result = 0;
...
void *
clone_capsule (void *raw_capsule)
{
  PyObject *capsule = (PyObject *)raw_capsule;
