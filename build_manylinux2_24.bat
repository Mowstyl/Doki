...
docker exec manylinux_2_24 /bin/bash -c "auditwheel repair /output/doki_Mowstyl*cp36*whl -w /doki/dist"
docker exec manylinux_2_24 /bin/bash -c "auditwheel repair /output/doki_Mowstyl*cp37*whl -w /doki/dist"
docker exec manylinux_2_24 /bin/bash -c "auditwheel repair /output/doki_Mowstyl*cp38*whl -w /doki/dist"
docker exec manylinux_2_24 /bin/bash -c "auditwheel repair /output/doki_Mowstyl*cp39*whl -w /doki/dist"
::docker exec manylinux_2_24 /bin/bash -c "auditwheel repair /output/doki_Mowstyl*cp310*whl -w /doki/dist"

:: Install doki for all available python versions
docker exec manylinux_2_24 /bin/bash -c "python3.6 -m pip install --user /doki/dist/doki_Mowstyl*cp36*manylinux_2_24*.whl"
docker exec manylinux_2_24 /bin/bash -c "python3.7 -m pip install --user /doki/dist/doki_Mowstyl*cp37*manylinux_2_24*.whl"
docker exec manylinux_2_24 /bin/bash -c "python3.8 -m pip install --user /doki/dist/doki_Mowstyl*cp38*manylinux_2_24*.whl"
docker exec manylinux_2_24 /bin/bash -c "python3.9 -m pip install --user /doki/dist/doki_Mowstyl*cp39*manylinux_2_24*.whl"
::docker exec manylinux_2_24 /bin/bash -c "python3.10 -m pip install --user /doki/dist/doki_Mowstyl*cp310*manylinux_2_24*.whl"
...
docker exec manylinux_2_24 /bin/bash -c "python3.6 /doki/tests/measure_tests.py 1 5 1000"
...
docker exec manylinux_2_24 /bin/bash -c "python3.6 /doki/tests/probability_tests.py 1 5"
:: Python 3.7
echo Python3.7
...
docker exec manylinux_2_24 /bin/bash -c "python3.7 /doki/tests/measure_tests.py 1 5 1000"
...
docker exec manylinux_2_24 /bin/bash -c "python3.7 /doki/tests/probability_tests.py 1 5"
:: Python 3.8
echo Python3.8
...
docker exec manylinux_2_24 /bin/bash -c "python3.8 /doki/tests/measure_tests.py 1 5 1000"
...
docker exec manylinux_2_24 /bin/bash -c "python3.8 /doki/tests/probability_tests.py 1 5"
:: Python 3.9
echo Python3.9
...
docker exec manylinux_2_24 /bin/bash -c "python3.9 /doki/tests/measure_tests.py 1 5 1000"
...
docker exec manylinux_2_24 /bin/bash -c "python3.9 /doki/tests/probability_tests.py 1 5"
:: Python 3.10
::echo Python3.10
...
::docker exec manylinux_2_24 /bin/bash -c "python3.10 /doki/tests/measure_tests.py 1 5 1000"
...
::docker exec manylinux_2_24 /bin/bash -c "python3.10 /doki/tests/probability_tests.py 1 5"
