...
docker exec manylinux_2_24 /bin/bash -c "python3.6 /doki/tests/density_matrix_tests.py 1 5"
:: Python 3.7
echo Python3.7
...
docker exec manylinux_2_24 /bin/bash -c "python3.7 /doki/tests/density_matrix_tests.py 1 5"
:: Python 3.8
echo Python3.8
...
docker exec manylinux_2_24 /bin/bash -c "python3.8 /doki/tests/density_matrix_tests.py 1 5"
:: Python 3.9
echo Python3.9
...
docker exec manylinux_2_24 /bin/bash -c "python3.9 /doki/tests/density_matrix_tests.py 1 5"
:: Python 3.10
echo Python3.10
...
docker exec manylinux_2_24 /bin/bash -c "python3.10 /doki/tests/density_matrix_tests.py 1 5"
